...
for i in range(1, 5489):
    ...
    huGray = cv.imread("./train/" + imgName, cv.IMREAD_GRAYSCALE)
    ...
    #
    # extractedText = pytesseract.image_to_string(imgGray)
    # print(extractedText)
...
generatedFeaturesDF.to_csv("engineered_features.csv")

additionalFeaturesDF = pd.read_csv("./train/Features/additional_features.csv")
colorHistogramDF = pd.read_csv("./train/Features/color_histogram.csv")
hogPCADF = pd.read_csv("./train/Features/hog_pca.csv")
...
featuresDF.to_csv("all_features.csv")
